import { AdminActivityFeed } from "@/admin/components/AdminActivityFeed";
import { AdminChart } from "@/admin/components/AdminChart";
import { AdminQuickActions } from "@/admin/components/AdminQuickActions";
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2 space-y-6">
          <AdminChart title="Traffic Sources" data={chartData} />
          <AdminChart title="Performance Metrics" data={performanceData} />
        </div>
